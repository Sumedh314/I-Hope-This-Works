...
void alliance_steak() {
	...
	robot.drive_distance(-2.75);
	pros::delay(300);
	intake_on();
	pros::delay(1000);
	robot.set_drive_voltages(-50);
	pros::delay(200);
	robot.set_drive_voltages(50);
	pros::delay(100);
	robot.set_drive_voltages(-50);
...
void red_left() {
	...
	robot.drive_to_point(-24, -20);
	robot.drive_to_point(-10, -19, 1);
}
...
void skills_autonomous() {
	...
	robot.turn_and_drive_to_point(46, -42, 1, 1);
	pros::delay(1000);
	robot.drive_distance(10);
	pros::delay(1000);
