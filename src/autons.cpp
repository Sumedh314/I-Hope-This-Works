...
void red_left() {
	...
	robot.drive_to_point(-55, -11.5, 1);
	pros::delay(100);
	robot.drive_distance(-5);
	pros::delay(200);
	// robot.drive_distance(-5);
